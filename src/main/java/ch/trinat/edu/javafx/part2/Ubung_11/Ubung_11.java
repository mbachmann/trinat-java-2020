package ch.trinat.edu.javafx.part2.Ubung_11;
...
public class Ubung_11 extends Application{
	...
	public void start(Stage primaryStage) throws Exception{
		...
		readButton.setOnAction(event-> {System.out.println("o = "+ selectionModel.selectedItemProperty().getValue());
		});
		
		removeButton.setOnAction(event-> {String selectedValue= selectionModel.selectedItemProperty().getValue();

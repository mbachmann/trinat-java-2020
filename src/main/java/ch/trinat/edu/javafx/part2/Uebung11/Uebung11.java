package ch.trinat.edu.javafx.part2.Uebung11;
...
public class Uebung11 extends Application {
    @Override
    public void start(Stage primaryStage) throws Exception {
        ...
        removeButton.disableProperty().bind(
                Bindings.isNull(selectionModel.selectedItemProperty())); addButton.setOnAction(evt -> {

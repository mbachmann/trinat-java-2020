package ch.trinat.edu.javafx.part2.Ubung_13;
...
public class SomeShapes extends Application{
	...
	public void start(Stage primaryStage) {
		...
		private void drawShapes(Pane root) {
			...
			line.setStroke(Color.RED);line.setStrokeWidth(5);
			...
			c2.setFill(null);
			c2.setStrokeWidth(5);root.getChildren().add(c2);
			Rectangle r1= new Rectangle(120, 10, 40, 40);
			r1.setStroke(null);r1.setFill(Color.GREEN);
			root.getChildren().add(r1);
			Rectangle r2= new Rectangle(170, 10, 40, 40);
			r2.setStroke(Color.RED);r2.setFill(null);
			r2.setStrokeWidth(5);

package ch.trinat.edu.javafx.part2.Uebung14;
...
// Drawing a Circle and registering the event handler
    Circle circle1 = new Circle(150, 135, 25,Color.BROWN);
...
// Creating a Group object and a a scene object
    Group root = new Group(circle1, circle2, circle3, text);
    Scene scene = new Scene(root, 600, 300);
// Setting the fill color to the scene and the title
    scene.setFill(Color.LAVENDER); stage.setTitle("Event Filters Example"); stage.setScene(scene);

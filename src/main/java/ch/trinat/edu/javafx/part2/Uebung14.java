...
public class Uebung14 extends Application {

    @Override
    public void start(Stage stage) {
        EventHandler<MouseEvent> eventHandler = getEventHandler();// Drawing a Circle and registering the event handler
        Circle circle = new Circle(150, 135, 25, Color.BROWN);
        circle.addEventFilter(MouseEvent.MOUSE_CLICKED, eventHandler); // Drawing a Circle2 and registering the event
        // handler
        ...
        circle3.addEventFilter(MouseEvent.MOUSE_CLICKED, eventHandler); // Setting the text with coordinates

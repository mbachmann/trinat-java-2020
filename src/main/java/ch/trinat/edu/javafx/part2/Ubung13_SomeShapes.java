...
public class Ubung13_SomeShapes extends Application {
	...
	private void drawShapes(Pane root) {
		...
		Circle c2 = new Circle(120, 25, 20);
		c2.setStroke(Color.RED);
		c2.setFill(null);
		c2.setStrokeWidth(5);
		root.getChildren().add(c2);
		
		Rectangle r1 = new Rectangle(150, 10, 40, 40);
		r1.setStroke(null);
		r1.setFill(Color.GREEN);
		root.getChildren().add(r1);
		
		Rectangle r2 = new Rectangle(200, 10, 40, 40);

...
public class Uebung_4 extends Application {
    // Um dieses Programm zu Starten auf den Laucher_Uebung <Uebung_4.main(args)> eingeben
    ...
    private Pane createToolbarPane() {
        ...
        hbox.setStyle("-fx-border-width: 3;-fx-border-color: darkred;");
    ...
    private Pane createNavigationPane() {
        ...
        vbox.setStyle("-fx-border-width: 3;-fx-border-color: red;");

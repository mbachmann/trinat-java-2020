...
public class Uebung4 extends Application {
	...
	/*
	 * Pane createButton() { final Button btn = new Button();
	 * btn.setText("Add 'Hello World' Label"); final FlowPane pane = new FlowPane();
	 * pane.setPadding(new Insets(7, 7, 7, 7)); pane.getChildren().add(btn); //
	 * ActionHandler registrieren btn.setOnAction(event ->
	 * pane.getChildren().add(new Label("- Hello World! -"))); return pane; }
	 */

...
* den Durschnitt aller Jahresmittelwerte berechnet sowie alle Daten mit einem Jahresmittelwert �ber dem Grenzwert von 40 xx/m3 auf die Konsole schreibt. [Anzeigen...]
* 
* Es soll auch möglich sein, einen beliebigen Datensatz vollst�ndig auszudrucken. [Anzeigen...] Hinweis: Die Abk�rzung 'x' f�r Mikro wird nicht korrekt angezeigt. Ein 'x' kann in Java mit dem Code "\u03BC" generiert werden. 
* Die einzulesende Textdatei erhalten sie hier: [PM10_2003.txt...] (Rechtsklick um auf der Festplatte zu speichern). 
* 
* Hinweise
* Da Sie zu Beginn nicht wissen, wieviele Eintr�ge die Datei hat, k�nnen Sie einzelne Messstationen in einem Vector statt einem Array speichern. 
*/
...
public class Feinstaubbelastung {
	...
	public static void main (String[] args)
    {
        ...
        String[] result = null;
        int i = 0;
        String fileName = "src/main/java/ch/trinat/edu/etutorial/p03/oo5/PM10_2003.txt";
    ...
    public static Vector getStationenMittelWertHoeher(Vector<Messstation> daten, int wert)
    {
        Vector<Messstation> datenUeberWert = new Vector<Messstation>();
        for (int i = 0; i < daten.size(); i++)
        {
            Messstation tmpDaten = (Messstation) daten.get(i);

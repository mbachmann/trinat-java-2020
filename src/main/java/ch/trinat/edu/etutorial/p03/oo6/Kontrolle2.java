...
public class Kontrolle2 {
    
    public Kontrolle2 (JFrame frame, Haushaltsgeraet[] geraete) {
    ...
    public static void main(String[] args) {
        ...
        Waschmaschine w = new Waschmaschine ("Waschmaschine 1" , "Waschküche");
        ...
        Kontrolle2 kontrolle = new Kontrolle2(frame, geraete);

...
public class Kontrolle1 extends JPanel {
   ...
   public Kontrolle1 (final Adressbuch a, final JTextArea t, @SuppressWarnings("rawtypes") final Class[] classes, final JFrame fr) {

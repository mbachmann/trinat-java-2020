...
public class Kontrolle {
	...
	public Kontrolle (JFrame frame, Haushaltsgeraete[] geraete) {
	...
	private class Anzeige extends JPanel {
		...
		public Anzeige (Haushaltsgeraete[] geraete, JTextArea t) {
			this.text = t;
	...
	public static void main(String[] args) {
		...
		Mikrowelle m1 = new Mikrowelle("Mikrowelle 1", "Kuche");
		Backofen b1 = new Backofen("Backofen 1", "Kuche");
		Mikrowelle m2 = new Mikrowelle("Mikrowelle 2", "Wohnzimmer");
		Waschmaschine w1 = new Waschmaschine("Waschmaschine 1", "Keller");
		Waschmaschine w2 = new Waschmaschine("Waschmaschine 2", "Badezimmer");
		
		w1.start("Wolle 30°C", 7);
		m2.start(600, 1.5);
		b1.start(200, "Unter- und Oberhitze");
		
		Haushaltsgeraete [] geraete = {m1, m2, b1, w1, w2};
